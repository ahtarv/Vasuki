...
impl Memory{
    ...
    pub fn write_u32(&mut self, addr: u64, value: u32){
        ...
        let byes = value.to_le_bytes(); // convert the u32 into an array of 4 bytes in little - endian order, lets say i store 0x12345678, then adress 0: 0x78, then 1:0x56, then 2: 0x34, and then 3 will be 0x12, thats how x86 works. at least i have been told so.
